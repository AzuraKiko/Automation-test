...
class CurlTest(unittest.TestCase):
    ...
    def test_01(self):
        """Test case ID 001: Test valid token"""
    ...
    def test_02(self):
        """Test case ID 002: Test invalid  token"""
        url = BASE_URL_RETAIl + "portfolio/total/" + ACCOUNT
    ...
    def test_03(self):
        """Test case ID 003: Test expired token"""
        url = BASE_URL_RETAIl + "portfolio/total/" + ACCOUNT
    ...
    def test_04(self):
        """Test case ID 004: Test accoun not exist"""
    ...
    # def test_05(self):
    #     """Test case ID 005: Check response data"""
    # Liên quan đến đọc file SOD

    # self.assertIn("expected_data", response_data.json())
